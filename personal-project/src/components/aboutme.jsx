      ...
      <p className='title'>About Me</p>
        ...
        <div className='about-box'>
          ...
          <div className='box-info'>
            ...
            <p>I started studying Computer Science at Suffolk Community College and graduated with a 4.0 gpa.</p>
            <p>Along the way I learned Object-Oriented Programming by making projects.</p>
            <p>After Transferring to Oswego State University I started focusing on Web Development.</p>
